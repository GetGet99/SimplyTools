...
<template>
    <Feature category="math" tool="Base Converter" class="flex justify-center">
        ...
        <template #details>
            <p>
                This base converter lets you work across multiple number systems — base 10 (decimal), base 16 (hexadecimal),
