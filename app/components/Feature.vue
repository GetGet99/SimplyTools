    ...
    <div class="grid min-h-screen" style="grid-template-rows: 0px auto minmax(0, 1fr) auto;">
        ...
        <div class="app-hidden">
            <details v-if="!noDetails" class="text-center">
                <summary><span class="italic">Extra Info: <slot name="summary">We are working on this tool. 🔨</slot></span></summary>
                <div class="flex justify-center mt-2">
                    <div class="p-2 border control-border-control bg-card rounded-2 text-left max-w-max">
                        ...
                        <p class="italic text-center mt-4">SimplyTools are tools run locally in your browser. Easily accessible from all
                            your devices
                            with
